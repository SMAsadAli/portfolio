...
Set up and improve cloud infrastructure, CI/CD, deployment workflows, and operational foundations across AWS and GCP.

### 3. Full-Stack Product Delivery
Ship product features end to end when the work crosses backend, data, integrations, and UI surfaces.

### 4. System Design And Modernization
...
- Strong contrast, restrained accent color
- Editorial spacing rather than startup-dashboard styling
- Simple cards and sharp hierarchy
